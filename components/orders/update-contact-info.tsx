...
import { GET_QUOTE_DETAILS_RESPONSE, UPDATE_ORDER_CONTACT_INFO_CURL, UPDATE_ORDER_CONTACT_INFO_GO, UPDATE_ORDER_CONTACT_INFO_NODEJS, UPDATE_ORDER_CONTACT_INFO_PHP, UPDATE_ORDER_CONTACT_INFO_RESPONSE, UPDATE_QUOTE_CONTACT_INFO_CURL, UPDATE_QUOTE_CONTACT_INFO_GO, UPDATE_QUOTE_CONTACT_INFO_NODEJS, UPDATE_QUOTE_CONTACT_INFO_PHP, UPDATE_QUOTE_CONTACT_INFO_RESPONSE } from '@/data/text_data';
import { LanguageContext } from '@/app/contexts/context';
import Link from 'next/link';

const UpdateOrderContactInfo = () => {
    ...
    var resp_cb_params = {
        ...
        text: UPDATE_ORDER_CONTACT_INFO_RESPONSE,
    }
    ...
    const renderContent = () => {
        ...
        if (openedLibrary == "CURL") {
            ...
            cb_params.text = UPDATE_ORDER_CONTACT_INFO_CURL;
            return <CopyBlock {...cb_params} />

        } else if (openedLibrary == "PHP") {

            cb_params.text = UPDATE_ORDER_CONTACT_INFO_PHP;
            return <CopyBlock {...cb_params} />

        } else if (openedLibrary == "Node.js") {

            cb_params.text = UPDATE_ORDER_CONTACT_INFO_NODEJS;
            return <CopyBlock {...cb_params} />

        } else if (openedLibrary == "Go") {

            cb_params.text = UPDATE_ORDER_CONTACT_INFO_GO;
            return <CopyBlock {...cb_params} />
    ...
    return (
        <LanguageContext.Provider value={{ openedLibrary, setOpenedLibrary }}>
            <div className="contents_area">
                <section>
                    <div>
                        <h2 className="font-bold text-xl font-poppings">Update Order Contact Info</h2>
                    </div>
                    ...
                    <div className="font-poppings mt-6">
                        To update a order's contact info, you create a <span className="higlight">order contact object</span> and send it to the API endpoint
                    </div>
                ...
                <section className='mt-16'>
                    ...
                    <div className='w-full mt-6'>
                        ...
                        <Link href="/endpoints/orders/update-transit-info" className='text-blue-800'>How to update order transit info.</Link>
                    </div>
                </section>
            </div>
...
export default UpdateOrderContactInfo
...
import { COLLECT_SIGNATURE_CURL, COLLECT_SIGNATURE_GO, COLLECT_SIGNATURE_NODEJS, COLLECT_SIGNATURE_PHP, COLLECT_SIGNATURE_RESPONSE } from '@/data/text_data';
...
const CollectSignature = () => {
    ...
    var resp_cb_params = {
        ...cb_params,
        text: COLLECT_SIGNATURE_RESPONSE,
    }
    ...
    const renderContent = () => {
        ...
        if (openedLibrary == "CURL") {
            ...
            cb_params.text = COLLECT_SIGNATURE_CURL;
            return <CopyBlock {...cb_params} />

        } else if (openedLibrary == "PHP") {

            cb_params.text = COLLECT_SIGNATURE_PHP;
            return <CopyBlock {...cb_params} />

        } else if (openedLibrary == "Node.js") {

            cb_params.text = COLLECT_SIGNATURE_NODEJS;
            return <CopyBlock {...cb_params} />

        } else if (openedLibrary == "Go") {

            cb_params.text = COLLECT_SIGNATURE_GO;
            return <CopyBlock {...cb_params} />
    ...
    return (
        <LanguageContext.Provider value={{ openedLibrary, setOpenedLibrary }}>
            <div className="contents_area">
                <section>
                    <div>
                        <h2 className="font-bold text-xl font-poppings">Collect Shipper's Signature</h2>
                    </div>
                    <div className="font-poppings mt-2">
                        If you are here, it means you have setup you custom shipper signature url provided in the CRM's endpoint settings.
                    </div><div className='w-full mt-2'>
                        <img src='/screenshot-7.png' />
                    </div>
                    <div className='w-full mt-2'>
                        Example: if you created a link <strong className='text-blue-800 ml-1 mr-1'>https://my-web-domain.com/shipper-signature.php</strong>
                        ...
                        <strong className='text-blue-800 ml-1 mr-1'>https://my-web-domain.com/shipper-signature.php?token=</strong>
                    </div>

                    <div className="font-poppings mt-6">
                        To collect a shipper's signature, you create a <span className="higlight">get signature object</span> and send it to the API endpoint
                    </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td className="arg_tbl_bdy">
                                        ...
                                        <div className='w-full mt-1'><strong>Expected Value:</strong> orders/collect-signature</div>
                                    </td>
                                    <td className="arg_tbl_bdy">This is a constant value and the only accepted value to collect shipper's signature
                                        is <span className='default-value'>orders/collect-signature</span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td className="arg_tbl_bdy">
                                        <div className='w-full'>
                                            ...
                                            we appended to the end of your shipper signature URL provided in the settings/endpoints page
                                        </div>
                                        <div className='w-full mt-2'>
                                            <img src='/screenshot-7.png' />
                                        </div>
                ...
                <section className='mt-16'>
                    ...
                    <div className='w-full mt-6'>
                        ...
                        <Link href="/endpoints/payments/add-new-payment" className='text-blue-800'>How to add new payment.</Link>
                    </div>
                </section>
